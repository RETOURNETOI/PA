...
<main class="carrer-forum">

<h1 class="texte-centre"
id="forum">Forum communautaire</h1>

<form class="carte" id="formulaire-nouveau-post"><div class="corps-carte">
<h3 class="titre-carte" id="creerpost">Créer un post</h3>
<input placeholder="Titre du post" required class="champ-texte" id="champ-titre" type="text">
<textarea id="champ-contenu" rows="4" required class="champ-texte" placeholder="Contenu du post"></textarea>
<button type="submit" id="publier" class="btn btn-outline-primaire largeur-100">Publier</button>
</div></form>

<section class="mt" id="liste-publications">
</section>
